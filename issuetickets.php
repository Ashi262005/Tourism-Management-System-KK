...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated col-md-8" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Issue Tickets</h3>
		<a class="col-md-4" href="#" data-toggle="modal" data-target="#myModal3" style="text-align: end;color: blue;
    font-weight: bold;"> Write Us </a>
